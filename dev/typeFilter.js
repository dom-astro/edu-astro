class TypeFilter {
	...
	setupGui(params) {
		...
		this.eDimSelect = this.gui.querySelector('#dimSelect');
...
/*		this.eDimFilter.addEventListener('keydown', listenerFilter);
	...
	getHtmlCode(dimList) {
		var html  = '<div class="ag-wrapper ag-input-wrapper ag-text-field-input-wrapper" style="margin: 10px">';
			...
			html += '  <select id="dimSelect" class="ag-theme-alpine ag-select ag-picker-field-wrapper" multiple>';
